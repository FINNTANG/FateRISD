...
## 游戏名称配置
define config.name = _("FATE RISD")
define config.version = "1.0"

## 构建设置
define build.name = "FATERISD"
...
init python:
    # 界面大小
    gui.init_resolution = (1920, 1080)
    
    # 对话框边距
    gui.textbox_xmargin = 50
    gui.textbox_ymargin = 30
    
    # 确保对话框宽度适合全屏
    gui.textbox_width = 1820  # 1920 - (2 * gui.textbox_xmargin)